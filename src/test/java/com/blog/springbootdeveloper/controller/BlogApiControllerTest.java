...
class BlogApiControllerTest {
    ...
    public void findAllArticles() throws Exception {
        ...
        // then
        result.andExpect(status().isOk()).andExpect(jsonPath("$[0].title").value(title)).andExpect(jsonPath("$[0].content").value(content));
    }
    ...
    public void findArticle() throws Exception {
        ...
        // then
        result.andExpect(status().isOk()).andExpect(jsonPath("$.title").value(title)).andExpect(jsonPath("$.content").value(content));
    }
    ...
    void updateArticle() throws Exception {
        ...
        // then
        result.andExpect(status().isOk()).andExpect(jsonPath("$.title").value(newTitle)).andExpect(jsonPath("$.content").value(newContent));
    }
}